...
public class b4xset extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.BellNumber2.b4xset");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.BellNumber2.b4xset.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public b4a.BellNumber2.b4xorderedmap _vvvvvvvvvvv1 = null;
...
public String  _vvvvvvvvvvv3(Object _value) throws Exception{
 //BA.debugLineNum = 9;BA.debugLine="Public Sub Add(Value As Object)";
 //BA.debugLineNum = 10;BA.debugLine="map.Put(Value, \"\")";
_vvvvvvvvvvv1._vvvvvvvv6 /*String*/ (_value,(Object)(""));
 //BA.debugLineNum = 11;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.objects.collections.List  _vvvvvvvvvvv4() throws Exception{
 //BA.debugLineNum = 29;BA.debugLine="Public Sub AsList As List";
 //BA.debugLineNum = 30;BA.debugLine="Return map.Keys";
if (true) return _vvvvvvvvvvv1._getvvvvvvvv5 /*anywheresoftware.b4a.objects.collections.List*/ ();
...
_vvvvvvvvvvv1 = new b4a.BellNumber2.b4xorderedmap();
...
_vvvvvvvvvvv1._vvvvv1 /*String*/ ();
 //BA.debugLineNum = 27;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvvvvvvv5(Object _value) throws Exception{
...
if (true) return _vvvvvvvvvvv1._vvvvvvvv1 /*boolean*/ (_value);
...
if (true) return _vvvvvvvvvvv1._getvvvvv5 /*int*/ ();
...
_vvvvvvvvvvv1._initialize /*String*/ (ba);
 //BA.debugLineNum = 7;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvv1(Object _value) throws Exception{
 //BA.debugLineNum = 13;BA.debugLine="Public Sub Remove(Value As Object)";
 //BA.debugLineNum = 14;BA.debugLine="map.Remove(Value)";
_vvvvvvvvvvv1._vvvvvvv1 /*String*/ (_value);
