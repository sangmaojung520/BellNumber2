...
public class b4xbitset extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.BellNumber2.b4xbitset");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.BellNumber2.b4xbitset.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public int[] _vvvvv6 = null;
...
_vvvvv6 = new int[(int) (__c.Bit.ShiftRight(_vvvvv7,(int) (5))+1)];
;
 //BA.debugLineNum = 60;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvv2(int _index) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
public String  _vvvvv4(int _index,boolean _value) throws Exception{
int _dindex = 0;
int _offset = 0;
int _blockvalue = 0;
...
_vvvvv6[_dindex] = _newblockvalue;
