...
public class b4xcomparatorsort extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.BellNumber2.b4xcomparatorsort");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.BellNumber2.b4xcomparatorsort.class).invoke(this, new Object[] {null});
        else
...
public int  _vvvvvvvvv7(anywheresoftware.b4a.objects.collections.List _data,int _startindex,int _length,int _pivotindex,Object _comparator) throws Exception{
...
_vvvvvvvvvv2(_data,_startindex,_pivotindex,(int) (_length-1));
...
_vvvvvvvvvv2(_data,_startindex,(int) (_l-1),_i);
 };
 }
};
 //BA.debugLineNum = 40;BA.debugLine="Swap(Data, StartIndex, Length - 1, L)";
_vvvvvvvvvv2(_data,_startindex,(int) (_length-1),_l);
 //BA.debugLineNum = 41;BA.debugLine="Return L";
if (true) return _l;
 //BA.debugLineNum = 42;BA.debugLine="End Sub";
return 0;
}
public String  _vvvvvvvvv0(anywheresoftware.b4a.objects.collections.List _data,int _startindex,int _length,Object _comparator) throws Exception{
int _pivotindex = 0;
int _r = 0;
...
_r = _vvvvvvvvv7(_data,_startindex,_length,_pivotindex,_comparator);
 //BA.debugLineNum = 25;BA.debugLine="QuickSort(Data, StartIndex, r, Comparator)";
_vvvvvvvvv0(_data,_startindex,_r,_comparator);
 //BA.debugLineNum = 26;BA.debugLine="QuickSort(Data, StartIndex + r + 1, Length - r -";
_vvvvvvvvv0(_data,(int) (_startindex+_r+1),(int) (_length-_r-1),_comparator);
 };
 //BA.debugLineNum = 28;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvv1(anywheresoftware.b4a.objects.collections.List _data,Object _comparator) throws Exception{
...
_vvvvvvvvv0(_data,(int) (0),_data.getSize(),_comparator);
 //BA.debugLineNum = 18;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvvvv2(anywheresoftware.b4a.objects.collections.List _data,int _startindex,int _i1,int _i2) throws Exception{
Object _o = null;
