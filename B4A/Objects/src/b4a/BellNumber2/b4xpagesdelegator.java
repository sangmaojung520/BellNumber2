...
public class b4xpagesdelegator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.BellNumber2.b4xpagesdelegator");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.BellNumber2.b4xpagesdelegator.class).invoke(this, new Object[] {null});
        else
...
_vvvv7._vv3 /*b4a.BellNumber2.b4xpagesmanager*/ (getActivityBA())._activity_actionbarhomeclick /*String*/ ();
...
if (true) return _vvvv7._vv3 /*b4a.BellNumber2.b4xpagesmanager*/ (getActivityBA())._activity_keypress /*boolean*/ (_keycode);
...
_vvvv7._vv3 /*b4a.BellNumber2.b4xpagesmanager*/ (getActivityBA())._activity_pause /*String*/ ();
...
_vvvv7._vv3 /*b4a.BellNumber2.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvv5 /*String*/ (_vvvv7._vv3 /*b4a.BellNumber2.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvvv2 /*b4a.BellNumber2.b4xpagesmanager._b4xpageinfo*/ (),"B4XPage_PermissionResult",new Object[]{(Object)(_permission),(Object)(_result)});
...
_vvvv7._vv3 /*b4a.BellNumber2.b4xpagesmanager*/ (getActivityBA())._activity_resume /*String*/ ();
...
_vvvv7._vv3 /*b4a.BellNumber2.b4xpagesmanager*/ (getActivityBA())._vvvvvvvvvvvv4 /*String*/ (_menu);
...
_vvvv7._vv3 /*b4a.BellNumber2.b4xpagesmanager*/ (getActivityBA())._mainform_resize /*String*/ (_width,_height);
